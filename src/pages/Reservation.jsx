...
return;
 ...
 return (
    <Container className="Reservation-Container opacity-80">
      <Row className="justify-content-center shadow-lg p-2 light bg-body-secondary glass text-dark-subtle mt-5">
